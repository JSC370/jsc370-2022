...
Build an automatic counter of sars-cov-2 papers using
[PubMed](https://pubmed.ncbi.nlm.nih.gov/). You will need to apply XPath
as we did during the lecture to extract the number of results returned
by PubMed in the following web address:
...
You need to query the Entrez API The parameters passed to the query are
...
For example, if we wanted to add a direct link the HTML page of lab 5,
